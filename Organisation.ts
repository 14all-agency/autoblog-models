...
export const OrganisationResult = z.object({
  ...
  disabledNotifications: z.boolean().optional().nullable(),
  ...
  partnerDevelopment: z.boolean().optional().nullable().describe("Shopify partner development store"),
  ...
  ignoreLanguageChecks: z.boolean().optional().nullable(),
  ignoreLinkChecks: z.boolean().optional().nullable(),
...
export const OrganisationModelSchema = z.object({
  ...
  disabledNotifications: OrganisationResult.shape.disabledNotifications,
  ...
  partnerDevelopment: OrganisationResult.shape.partnerDevelopment,
  ...
  ignoreLanguageChecks: OrganisationResult.shape.ignoreLanguageChecks,
  ignoreLinkChecks: OrganisationResult.shape.ignoreLinkChecks,
...
export const OrganisationModel = {
  convertFromEntity(entity: OrganisationResultEntity, includeCredentials = false): OrganisationModel {
    ...
    const obj: OrganisationModel = {
      ...
      disabledNotifications: entity.disabledNotifications || false,
      ...
      partnerDevelopment: entity.partnerDevelopment ?? null,
      ...
      ignoreLanguageChecks: entity.ignoreLanguageChecks || false,
      ignoreLinkChecks: entity.ignoreLinkChecks || false,
